...
import com.ozner.yiquan.UIView.FileUtils;
...
//    }
    ...
    protected List<NetCacheWork> doInBackground(NetCacheWork... params) {
             List<NetCacheWork> listnotdoworks=new ArrayList<NetCacheWork>();
                listnotdoworks = CSqlCommand.getInstance().GetNetCacheWorks(context);
                ...
                for (NetCacheWork netCacheWork :listnotdoworks) {
                    ...
                    }else
                    {
                        ...
                        else
                        {
                            ...
                            CSqlCommand.getInstance().UpdateNetCacheFaildCount(this.context,netCacheWork);
                        }
                    }
                }
            }
