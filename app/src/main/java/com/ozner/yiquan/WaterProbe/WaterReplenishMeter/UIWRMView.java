package com.ozner.yiquan.WaterProbe.WaterReplenishMeter;
...
import com.ozner.yiquan.WaterProbe.PurifierExp.UIZChartAdapter;
 ...
 */
public class UIWRMView extends WaterReplMeterBaseView {
    float ani_y_rate = 0;
    float ani_x_rate = 0;
    ...
    public UIWRMView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
