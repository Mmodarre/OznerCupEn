...
/**
 * Created by taoran on 2015/11/25.
 */
public class UIXTempChartView extends UIXChartView {


    private RelativeLayout tds_layout, chart_layout;

    public UIXTempChartView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init() {
        super.init();
        //控制侧边数值的变化
        valueTag.put(CupRecord.Temperature_Low_Value, getResources().getString(R.string.good_temperature));
        valueTag.put(CupRecord.Temperature_High_Value, getResources().getString(R.string.normal_temperature));
        valueTag.put(100, getResources().getString(R.string.bad_temperature));
    }
...
//            tds_layout.setVisibility(View.VISIBLE);
