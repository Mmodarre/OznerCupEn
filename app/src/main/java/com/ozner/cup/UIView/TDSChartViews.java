...
/**
 * Created by taoran on 2015/11/26.
 */
...
public class TDSChartViews extends UIXChartView {
    ...
    public TDSChartViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init() {
        super.init();
        valueTag.put(CupRecord.TDS_Good_Value,getResources().getString(R.string.good_water));
        valueTag.put(CupRecord.TDS_Bad_Value,getResources().getString(R.string.normal_water));
    ...
    private final  static int LineColor400=0xffa28aea;
