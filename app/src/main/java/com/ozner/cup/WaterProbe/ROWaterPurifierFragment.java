 ...
 */
public class ROWaterPurifierFragment extends Fragment implements View.OnClickListener, OperateCallback<Void>, FootFragmentListener {
    boolean isPowerOn = false;
    boolean isCoolOn = false;
    boolean isHotOn = false;
    boolean state = false;
    boolean isOffLine = false;
    RelativeLayout rlay_hot, rlay_cool, rlay_power, rlay_purifier_tds, rlay_filterStatus, rlay_menu, rlay_purifier_tdsdata,rlay_top1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            waterPurifier = (WaterPurifier_RO_BLE) OznerDeviceManager.Instance().getDevice(MAC);
...
//            }
    ...
    private class UiUpdateAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String string) {
            if (ROWaterPurifierFragment.this != null && ROWaterPurifierFragment.this.isAdded()) {
                BindDataToView();
                switchCool(isCoolOn);
                switchHot(isHotOn);
            }
