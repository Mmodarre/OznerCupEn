...
package com.ozner.qianye.Alarm;
...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.ozner.yiquan.Alarm", "alarm", ALARMS);
        sURLMatcher.addURI("com.ozner.yiquan.Alarm", "alarm/#", ALARMS_ID);
    }
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        Log.v("mdy", "*** notifyChange() rowId: " + rowId + " url " + url);
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        Log.v("mdy", "Added alarm rowId = " + rowId);
