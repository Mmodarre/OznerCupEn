...
import com.ozner.qianye.slideleft.BaseFragment;


/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link FootNavEnFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FootNavEnFragment#newInstance} factory method to
...
public class FootNavEnFragment extends BaseFragment implements FootFragmentListener {
    ...
    public static FootNavEnFragment newInstance(String param1, String param2) {
        FootNavEnFragment fragment = new FootNavEnFragment();
...
//    }
    ...
    public void SetMessageCount(int i) {
        if(FootNavEnFragment.this.isAdded()) {
            if (i > 0) {
