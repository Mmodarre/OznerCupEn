 ...
 */
public class TapTDSChartView extends UIXChartView {
    public TapTDSChartView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init() {
        super.init();
        valueTag.put(CupRecord.TDS_Good_Value, getResources().getString(R.string.health));
        valueTag.put(CupRecord.TDS_Bad_Value, getResources().getString(R.string.generic));
        valueTag.put(CupRecord.TDS_Bad_Value * 2 - CupRecord.TDS_Good_Value, getResources().getString(R.string.bad));
//        valueTag.put(adapter.getMax(),)
    }
